            ...
            <div class="d-flex align-items-center">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a href="<?= $config['URL'] ?>user/update.php" class="dropdown-item text-end" type="button">
            ...
            <div class="offcanvas offcanvas-start bg-light" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div>
                    <ul class="navbar-nav justify-content-end flex-grow-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link px-3 border-bottom <?= $uri === '/afungaz/user/read_user.php' ? 'active' : '' ?>" href="<?= $config['URL'] ?>user/read_user.php"><i class="bi bi-clock-fill me-2"></i>Agendamentos</a>
                        </li>
